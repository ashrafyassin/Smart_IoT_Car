...
if(window.location.protocol === 'http:')
	server = "http://"<EC2 IP/>"/janus";
else
	server = "https://<EC2 IP>/janus";
...
var myroom = <room  number/>;	// Demo room
var myusername = "ROOM USER NAME";
var myid = null;
var mystream = null;
	...
	janus.attach(
		{
			...
			onremotestream: function(stream) {
				...
				$("#remotevideo"+remoteFeed.rfindex).bind("playing", function () {
					...
					var width = "Guy";
					var height = "Ayal";
					$("#waitnow").addClass('hide');
					$('#curres'+remoteFeed.rfindex).removeClass('hide');
